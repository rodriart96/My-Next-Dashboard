        ...
        <>
            ...
            <div className='flex space-x-2'>
                {count === 0 ?
                    ...
                    <button onClick={() => setCount(count - 1)} disabled className='flex items-center justify-center p-2 rounded-xl bg-gray-700 text-white hover:bg-gray-700 transition-all w-[100px] mr-2  opacity-75' >
                        -
                    </button>
